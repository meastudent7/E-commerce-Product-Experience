"""exploring_ecommerce_product URL Configuration
...
from exploring_ecommerce_product import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Sentiment_Type/$', remoteuser.Predict_Sentiment_Type, name="Predict_Sentiment_Type"),
    ...
    url(r'^View_Sentiment_Type_Ratio/$', serviceprovider.View_Sentiment_Type_Ratio, name="View_Sentiment_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Sentiment_Type/$', serviceprovider.View_Prediction_Of_Sentiment_Type, name="View_Prediction_Of_Sentiment_Type"),
