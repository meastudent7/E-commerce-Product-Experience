...
--
-- Host: localhost
-- Generation Time: Feb 21, 2023 at 10:28 AM
...
--
-- Database: `exploring_ecommerce_product`
--
CREATE DATABASE IF NOT EXISTS `exploring_ecommerce_product` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `exploring_ecommerce_product`;
...
('3l9renn6r1e2amn5v4uo85mrfbh9xmwt', 'eyJ1c2VyaWQiOjN9:1pUNLw:_5yYDJjkiJu3sZiG2DEjusUUCu5lNgNMps_oaOxwECI', '2023-03-07 07:46:20.128621'),
...
('82ulctqgf5iccd4o2qvgli1wbqnzqarm', 'eyJ1c2VyaWQiOjR9:1pUPoB:DbL2X-2z7r1Ns9f0wTrZrri4Z8q7oyMGKmQAhw6pPq8', '2023-03-07 10:23:39.455295'),
...
(3, 'Harish', 'Harish123@gmail.com', 'Harish', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(4, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male');
...
(44, 'Extra Tree Classifier', '87.48728382502543'),
(45, 'SVM', '92.98067141403867'),
(46, 'Logistic Regression', '92.98067141403867'),
(47, 'Gradient Boosting Classifier', '90.74262461851475');
...
--
-- Table structure for table `remote_user_product_sentiment_analysis`
--

CREATE TABLE IF NOT EXISTS `remote_user_product_sentiment_analysis` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `reviewerID` varchar(300) NOT NULL,
  `Product_Id` varchar(300) NOT NULL,
  `reviewerName` varchar(300) NOT NULL,
  `reviewText` varchar(30000) NOT NULL,
  `overall_rating` varchar(300) NOT NULL,
  `summary` varchar(300) NOT NULL,
  `reviewTime` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=11 ;

--
-- Dumping data for table `remote_user_product_sentiment_analysis`
--

INSERT INTO `remote_user_product_sentiment_analysis` (`id`, `reviewerID`, `Product_Id`, `reviewerName`, `reviewText`, `overall_rating`, `summary`, `reviewTime`, `Prediction`) VALUES
(7, 'A1V6CQACZ9IOLC', 'B007WTAJTO', 'Aaron Graves', 'The read and write speeds are better than the Samsung SD card that I had previously. I would not hesitate to buy another one of these great Micro SD cards from SanDisk. I also own their Clip plus MP3 player and it works very well. I think I''m becoming a fan of the SanDisk products.\r\n', '5', 'Very good little Micro SD card', '05-02-21', 'Positive'),
(8, 'A2Q3ICGWZLY3JJ', 'B007WTAJTO', '98020', 'It works, but file writes are a bit slower than expected on a USB3 reader.Also, both reads and writes are FASTER with the card inside the standard-size SD adapter (15 MB/s vs 10 write; 45 MB/s vs 22 MB/s read) on the same card reader.  Can''t figure why...\r\n', '3', 'It works, but not as fast as expected', '20-11-20', 'Negative'),
(9, 'A3EA7KGYC8LB0', 'B007WTAJTO', 'Aaron "Aaron"', 'Heard that the card''s write speed is insufficient, however I have used it extensively and haven''t had a single problem with it!!\r\n', '5', 'Use it for my GoPro Hero 3+ Black', '17-02-21', 'Positive'),
(10, 'A6K6Z2V4TUVZ7', 'B007WTAJTO', 'adam smith', '32gb of storage for my new Asus tablet, what''s not to love? I can''t imagine paying more for the model with the upgraded storage, especially since it''s usually like $100 more. This thing was cheap and works great.\r\n', '5', 'Cheap and awesome.', '26-11-20', 'Positive');
